...
const HomeContent = () => {
  ...
  return (
    <>
      ...
      >
        <h2 className="text-primary font-extrabold xl:text-5xl md:text-4xl text-xl">Iridescent</h2>
      ...
      >
        <span className="font-semibold">Hi! My Name Is Iridescent | Frontend Developer,</span> using Node.js for
